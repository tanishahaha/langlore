           ...
           <div className="container mx-auto px-4 py-8 md:py-20 relative">
                ...
                <div className="flex flex-col md:flex-row justify-between relative z-10">
                    <div className="flex flex-col w-full md:w-1/2 mb-8 md:mb-0 md:pr-4">
                        ...
                        <button className="bg-bluee px-6 py-2 rounded-[16px] hover:shadow-inner md:w-1/3 w-2/3 md:text-[1.5rem] text-[1rem]  text-white hover:text-pri">Explore the course</button>
                    </div>
