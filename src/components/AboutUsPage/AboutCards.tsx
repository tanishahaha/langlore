    ...
    return (
        <div className="flex text-gray-300  flex-col items-center p-4 ">
            ...
            <div className="flex space-x-3 mt-4">
                <a href={linkedin} className="text-white hover:text-gray-100" target="_blank"><FaLinkedin size={24}/></a>
                <a href={twitter} className="text-white hover:text-gray-100" target="_blank"><FaTwitter size={24}/></a>
                <a href={website}  className="text-white hover:text-gray-100 " target="_blank"><FaGlobe size={24}/></a>
            </div>
        </div>
    );
};
