...
const NewsLetter: React.FC = () => {
    return (
        <div className="custom-bgColor text-white w-full md:w-2/3 m-auto rounded-2xl flex flex-col md:flex-row items-center justify-between md:px-10 py-4 border-t border-white">
            ...
            <div className="flex flex-col items-center  m-auto md:w-1/2">
        <h2 className="font-bold md:text-3xl text-2xl m-auto text-gray-400">Curious about cultures?</h2>
